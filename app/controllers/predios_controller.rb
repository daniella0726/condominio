class PrediosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @predio.save
        format.html { redirect_to predio_url(@predio), notice: "Predio was successfully created." }
  ...
  def update
    respond_to do |format|
      if @predio.update(predio_params)
        format.html { redirect_to predio_url(@predio), notice: "Predio was successfully updated." }
  ...
  private
    ...
    def predio_params
      params.require(:predio).permit(:tipo, :ubicacion, :tipo_no, :ubicacion_no)
    end
end
