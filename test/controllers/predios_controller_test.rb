...
class PrediosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create predio" do
    assert_difference("Predio.count") do
      post predios_url, params: { predio: { tipo: @predio.tipo, tipo_no: @predio.tipo_no, ubicacion: @predio.ubicacion, ubicacion_no: @predio.ubicacion_no } }
    end
  ...
  test "should update predio" do
    patch predio_url(@predio), params: { predio: { tipo: @predio.tipo, tipo_no: @predio.tipo_no, ubicacion: @predio.ubicacion, ubicacion_no: @predio.ubicacion_no } }
